...
if (isset($_POST['submission_id'], $_POST['marks'], $_POST['verified'], $_POST['category_id'])) {
...
mysqli_stmt_close($stmt);
    ...
    $update_query = "UPDATE submissions SET marks = ?, verified = ? WHERE id = ?";
    $stmt = mysqli_prepare($connection, $update_query);

    // Bind parameters
    mysqli_stmt_bind_param($stmt, 'iii', $marks, $verified, $submission_id);
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        try {
            ...
            $mail->Password = 'syjvrdahohseyykk'; // Your SMTP password
            ...
            // Content
            $mail->isHTML(true);
            $mail->Subject = 'Assignment Correction Notification';
            $mail->Body = "Dear $student_name,<br><br>Your assignment submission has been reviewed. The following updates have been made:<br><br>" .
                          "Marks: $marks<br>" .
