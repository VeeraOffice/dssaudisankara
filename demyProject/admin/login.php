...
$connection = mysqli_connect('localhost', 'root', 'veera', 'demy');
...
if (!$connection) {
    ...
    if (mysqli_num_rows($query_runner) > 0) {
        ...
        try {
            ...
            $mail->SMTPAuth = true;
            $mail->Username = 'veeravinu345@gmail.com'; // Your SMTP username
            $mail->Password = 'kdgmbfkrmcvmdhyd'; // Your SMTP password
            $mail->SMTPSecure = 'ssl';
            $mail->Port = 465;

            // Recipients
            $mail->setFrom('veeravinu345@gmail.com', 'DSS Attendance System');
