        ...
        <div class="col-md-12">
            <div class="card mt-4">
                <div class="card-header">
                    ...
                    <p id="progressIndicator">Question 1 of <?php echo $total_questions; ?></p> <!-- Progress Indicator -->
                </div>
                <div class="card-body">
...
<script>
            ...
            formHtml += `
                <div class="question-form" id="question-form-${i}">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="question${i}" name="question[]" class="form-control mb-2" rows="3" required></textarea>
                    </div>
                    <div class="form-group">
                        <label>Options:</label>
                        <textarea name="options[${i}][option1]" class="form-control mb-2" placeholder="Option 1" rows="2" required></textarea>
                        <textarea name="options[${i}][option2]" class="form-control mb-2" placeholder="Option 2" rows="2" required></textarea>
                        <textarea name="options[${i}][option3]" class="form-control mb-2" placeholder="Option 3" rows="2" required></textarea>
                        <textarea name="options[${i}][option4]" class="form-control mb-2" placeholder="Option 4" rows="2" required></textarea>
    ...
    function validateForm() {
        // Simple validation: Ensure the current question and options are not empty
        const questionForm = document.getElementById(`question-form-${currentQuestionIndex}`);
        const textareas = questionForm.querySelectorAll('textarea');
